  ...
  render() {
    ...
    return (
      <RegularLayout fabType={'hide'}>
        <Card>
          <CelText align={'center'}>Based on your current <CelText
          ...
          <CelText type={'H1'} weight={'700'} align={'center'}>{percentageNumber}% less</CelText>
          <Separator margin={'10 0 12 0'} />
          <CelText>Decrease your monthly interest payment from <CelText weight={'500'}>$XX</CelText> to <CelText weight={'500'}>$XX</CelText> when paying with CEL.</CelText>
        </Card>
        <CelButton
          margin={'20 0 0 0'}
          onPress={ () => actions.navigateTo('LoanPrepaymentPeriod')}>Pay with CEL</CelButton>
      </RegularLayout>
    );
  }
}
