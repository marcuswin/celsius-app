...
class NoKyc extends Component {
  constructor(props) {
    ...
    props.actions.getWalletDetails()
  }
          ...
          renderContent={(textStyles) => (
            <View>
              <Text style={[textStyles, { textAlign: "center" }]}>
                ...
                <Text onPress={() => actions.navigateTo("TransactionsOnHold")}
                      style={[textStyles, { textDecorationLine: "underline" }]}>
  ...
  renderPending() {
    ...
    return (
      <SimpleLayout
        ...
        ref={testUtil.generateTestHook(this, "NoKycPending.screen")}
      >
        ...
        <Image source={require("../../../../assets/images/bear-happyKYC3x.png")}
               style={[NoKycStyle.image, { resizeMode: "contain" }]}/>
        ...
        <Text style={[NoKycStyle.textTwo, { marginTop: 10, marginBottom: 30 }]}>
          While you're waiting for your profile verification to finish(usually within 24 hours), you can look around or
          join our Telegram.
        </Text>
  ...
  renderRejected() {
    ...
    return (
      ...
      >
        {this.renderInfoBubble()}
        <Image source={require("../../../../assets/images/bear-NoKYC3x.png")}
               style={[NoKycStyle.image, { marginTop: 5 }]}/>
        ...
        <Text style={[NoKycStyle.textTwo, { marginTop: 10, marginBottom: 0 }]}>
          Please, go through the KYC process again, or contact <Text
          onPress={() => Linking.openURL("mailto:hello@celsius.network")} style={NoKycStyle.textButton}>Celsius
          support.</Text>
        </Text>
        <CelButton
  ...
  renderNotStarted() {
    ...
    return (
      ...
      >
        {this.renderInfoBubble()}
        <Image source={require("../../../../assets/images/illuNoKYC3x.png")}
               style={[NoKycStyle.image, { resizeMode: "contain" }]}/>
        ...
        <Text style={[NoKycStyle.textTwo, { marginTop: 10 }]}>
          But first, please verify your identity to unlock all of the Celsius wallet features. Verification usually
          takes less than 24 hours - we'll send you a notification once you've passed.
        </Text>
        <CelButton
