...
class ConfirmYourLoan extends Component {
    ...
    if (loan.asset !== "USD") {
      return (
        <CelText align="center" type="H1"
                 weight="bold">{formatter.crypto(loan.loan_amount, loan.coin_loan_asset, {precision: 2})}</CelText>
      )
    }
    return (
      <CelText align="center" type="H1"
               weight="bold">{formatter.usd(loan.loan_amount, {precision: 0})}</CelText>
    )
  }
        ...
        >
          <View>
            ...
            <Card>
              ...
              <CelText type="H3" weight="700" align="center"
                       margin='5 0 10 0'>{formatter.crypto(loan.amount_collateral_crypto, loan.coin)}</CelText>
              <Card color={style.grayCard.color}>
                <CelText type="H6" weight="300">The exact amount of collateral needed will be determined upon approval.
                  Coins used for collateral will be locked and ineligible to earn interest.</CelText>
              </Card>
            </Card>
              ...
              <View style={style.horizontalCardContainer}>
                ...
                <View style={style.horizontalCardItem}>
                  ...
                  <CelText type="H3" weight="600"
                           align="center">{formatter.percentage(loan.interest)}%</CelText>
                </View>
              </View>
            </Card>
            ...
            <Card color={style.blueCard.color}>
              <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}>Reduce your interest rate
                by</CelText>
              <CelText type="H3" weight="600" align="center"
                       color={style.blueCardBoldText.color}>{formatter.percentage(loan.loan_interest_bonus)} %</CelText>
              ...
              <View style={style.horizontalCardContainer}>
                <View style={style.horizontalCardItem}>
                  <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}> Monthly
                    Interest</CelText>
                  <CelText type="H3" weight="600" align="center"
                           color={style.blueCardBoldText.color}>{formatter.crypto(loan.monthly_payment_in_cel, 'CEL', {precision: 2})}</CelText>
                </View>
                ...
                <View style={style.horizontalCardItem}>
                  <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}>Total
                    Interest</CelText>
                  <CelText type="H3" weight="600" align="center"
                           color={style.blueCardBoldText.color}>{formatter.crypto(loan.total_interest_in_cel, 'CEL', {precision: 2})}</CelText>
                </View>
              </View>
              ...
              <Card noBorder color={STYLES.COLORS.WHITE_OPACITY1}>
                <View style={style.horizontalCardContainer}>
                  <View style={style.horizontalCardItem}>
                    <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}> Original Monthly
                      Interest</CelText>
                    <CelText type="H3" weight="600" align="center" color={style.blueCardBoldText.color}
                             strikethrough>{formatter.usd(loan.original_monthly_interest_payment_in_usd)}</CelText>
                  </View>
                  ...
                  <View style={style.horizontalCardItem}>
                    <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}>Discounted Monthly
                      Interest</CelText>
                    <CelText type="H3" weight="600" align="center"
                             color={style.blueCardBoldText.color}>{formatter.usd(loan.discounted_monthly_interest_payment_in_usd)}</CelText>
                  </View>
                </View>
              </Card>
              ...
              <Card noBorder color={STYLES.COLORS.WHITE_OPACITY1}>
                <View style={style.horizontalCardContainer}>
                  <View style={style.horizontalCardItem}>
                    <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}> Original Total
                      Interest</CelText>
                    <CelText type="H3" weight="600" align="center" color={style.blueCardBoldText.color}
                             strikethrough>{formatter.usd(loan.original_total_interest_in_usd)}</CelText>
                  </View>
                  ...
                  <View style={style.horizontalCardItem}>
                    <CelText type="H6" weight="300" align="center" color={style.blueCardText.color}>Discounted Total
                      Interest</CelText>
                    <CelText type="H3" weight="600" align="center"
                             color={style.blueCardBoldText.color}>{formatter.usd(loan.discounted_total_interest_in_usd)}</CelText>
                  </View>
                </View>
              </Card>

              <CelText type="H6" weight="300" italic align="center" margin=' 0 0 5 0'
                       color={style.blueCardText.color}> This rate is subject to change based on your loyalty level and
                CEL price at the time of payment.</CelText>
            </Card>
            ...
            <Card>
              ...
              <CelText type="H3" weight="700" align="center"
                       margin='5 0 10 0'>{formatter.usd(loan.margin_call_price)}</CelText>
              <Card color={style.grayCard.color}>
                <CelText type="H6"
                         weight="300">{`If ${loan.coin} drops bellow ${formatter.usd(loan.margin_call_price,)}, you will be required to add collateral to meet the minimum LTV.`}</CelText>
              </Card>
            </Card>
            ...
            <Card>
              ...
              <CelText type="H3" weight="700" align="center"
                       margin='5 0 10 0'>{formatter.usd(loan.liquidation_call_price)}</CelText>
              <Card color={style.grayCard.color}>
                <CelText type="H6"
                         weight="300">{`If ${loan.coin} drops below ${formatter.usd(loan.liquidation_call_price)} and margin call has not been met we will liquidate a portion of your collateral to cover the Margin Call.`}</CelText>
              </Card>
            </Card>

            <CelButton onPress={() => actions.navigateTo('LoanTermsOfUse')}
                       margin="22 0 0 0">Continue</CelButton>
          </View>
        </RegularLayout>
      </View>
    )
  ...
  render() {
    ...
    const isLoading = !loan || apiUtil.areCallsInProgress([API.APPLY_FOR_LOAN_PREVIEW_DATA], callsInProgress)
