                ...
                <View>
                  <View style={style.interestCardWrapper}>
                    ...
                    <CelText type="H3" weight='600'
                             margin={"3 0 3 0"}>{formatter.usd(coinDetails.interest_earned_usd)}</CelText>
                    <CelText type="H6"
                             weight='300'>{formatter.crypto(coinDetails.interest_earned, coinDetails.short)}</CelText>
                  </View>
