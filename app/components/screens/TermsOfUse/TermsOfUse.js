    ...
    this.state = {
      terms: [
        ...
        },
        {
          heading: "11. Deposits",
          text:
            "You can make a deposit to your Account by transferring Eligible Digital Assets to the deposit address provided by Celsius. The transfer of such Eligible Digital Assets to your Account will not be deemed settled and completed until the Blockchain transaction is deemed confirmed to the relevant address.\n",
        },
        {
          heading: "12. Withdrawals",
          text:
            "You may make a complete or partial withdrawal of funds from your Account at any time. Celsius initiates the withdrawal process immediately following a withdrawal request when possible; however, we may require up to three (3) business days after you submit your withdrawal request to process the withdrawal. \n" +
            "\n" +
        ...
        },
        {
          ...
          text:
            "In consideration for the interest earned on your Account and the use of our Services, you grant Celsius the right, subject to applicable law, without further notice to you, to hold the Digital Assets available in your account in Celsius’ name or in another name, and to pledge, re-pledge, hypothecate, re-hypothecate, sell, lend, or otherwise transfer or use any amount of such Digital Assets, separately or together with other property, with all attendant rights of ownership, and for any period of time, and without retaining in Celsius’ possession and/or control a like amount of Digital Assets or any other monies or assets, and to use or invest such Digital Assets at Celsius’ own risk. You acknowledge that, with respect to assets used by Celsius pursuant to this paragraph:\n" +
        ...
        },
        {
          heading: "16. CelPay",
          text:
            "CelPay is Celsius' proprietary Digital Asset payment tool for mobile applications. CelPay allows you to send payments in supported Digital Assets (currently BTC and ETH) to other registered Users. \n" +
            "\n" +
        ...
        },
        {
          ...
          text:
            "You are advised to notify us IMMEDIATELY via email to security@celsius.network if you believe that an electronic transfer has been made without your permission, or if your statement shows transfers that you did not make. YOU ACCEPT ALL RISKS OF UNAUTHORIZED ACCESS AND USE OF YOUR ACCOUNT.",
        },
        {
        ...
        },
        {
          ...
          text:
            "We may disclose information to third parties about you, your Account, or the transfers you make:\n" +
  ...
  renderScreen(section, index) {
    ...
    return (
      <View key={index} style={style.wrapper}>
        ...
        <CelText style={style.text} margin="0 16 0 16">
          {" "}
          {section.text}
        </CelText>
      </View>
