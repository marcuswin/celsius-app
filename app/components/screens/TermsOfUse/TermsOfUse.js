  ...
  renderScreen(section, index) {
    ...
    return (
      <View key={index} style={style.wrapper}>
        <CelText type='H3' weight='bold' style={style.heading} margin="0 16 0 16">{section.heading}</CelText>
        <CelText style={style.text} margin="0 16 0 16"> {section.text}</CelText>
      </View>
    );
  }
