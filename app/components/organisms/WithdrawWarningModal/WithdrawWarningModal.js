...
class WithdrawWarningModal extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <CelText type="H2" weight="bold" align="center" style={style.title}>
          You didn't enter a {tagUpperCase}
        </CelText>
        <CelText type="H4" weight="300" align="left" style={style.text}>
          To prevent permanent loss of your funds, please check if your address
          has a{" "}
          <CelText type="H4" weight="300" color={STYLES.COLORS.CELSIUS_BLUE}>
            {tag}
          </CelText>
        </CelText>
        ...
        <View>
          <CelButton disabled={isChecked === false} onPress={navigateNext}>
            Continue
          </CelButton>
        </View>
      </CelModal>
