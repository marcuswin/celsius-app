...
const CelPayReceivedModal = ({ transfer, navigateTo, closeModal }) => {
  ...
  return (
    <CelModal
      ...
      modalType={"celPay"}
    >
      <CelText type="H2" align="center" weight="bold" margin="5 0 15 0">
        Congrats!
      </CelText>
      ...
      <CelText align="center">
        ...
        . It's already earning interest in your wallet which will be paid out on
        a weekly basis. Go to your wallet to find out more about interest rates.
      </CelText>
