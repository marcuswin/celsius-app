...
class BottomNavigation extends Component {
  ...
  static defaultProps = {
    navItemsLeft: [
      { label: 'Borrow', screen: 'BRWAllLoans', icon: 'Borrow', active: ['BRWEnterAmount', 'BRWChooseCollateral', 'BRWLoanOption', 'BRWTermOfLoan', 'BRWConfirmLoan', 'BRWAllLoans', 'BRWLoanDetails'] },
