...
class CelHeading extends Component {
    ...
    return {
      ...
      cancel: (
        <CelButton
          basic
          onPress={() => {
            this.setState({ activeSearch: false, searchValue: "" });
  ...
  getCenterContent = () => {
    ...
    return <View style={style.center}>{children}</View>;
  };
  ...
  getContent = () => {
    ...
    return (
      <View style={[style.content, paddings]}>
          ...
          {activeSearch && (
            ...
            >
              <CelInput
                ...
                margin="0 0 0 0"
                field="search"
                placeholder="Dialing code, country…"
                type="text"
                value={searchValue}
              />
            </View>
        ...
        <View style={style.right}>{this.getRightContent()}</View>
      </View>
    );
  };
