...
class SsnModal extends Component {
  ...
  render() {
    return (
      <CelModal name={MODALS.SSN_MODAL}>
        <CelText type="H2" weight="bold" align={"center"} margin={"0 0 20 0"}>
          You chose not to enter your SSN
        </CelText>
        <CelText type={"H4"} align={"left"} weight="300" margin={"0 0 20 0"}>
