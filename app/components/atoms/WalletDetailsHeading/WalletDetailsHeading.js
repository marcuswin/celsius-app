  ...
  render() {
    return <View style={WalletDetailsHeadingStyle.root}>
      <View style={{position: "relative", width: '100%'}}>
        ...
        <TouchableOpacity style={{position: 'absolute', top: 0, bottom: 0, left: 15, opacity: .6, justifyContent: 'center', alignItems: 'center'}} onPress={this.props.onPressPrevious}>
          <Icon name="IconChevronLeft" height='20' width='20' fill="white" viewBox="0 0 22 22" />
        </TouchableOpacity>
        <TouchableOpacity style={{position: 'absolute', top: 0, bottom: 0, right: 15, opacity: .6, justifyContent: 'center', alignItems: 'center'}} onPress={this.props.onPressNext}>
