...
export default {
  ...
  Celsius: (
    <Svg.Path id="celsius-logo" d="M24.7,12.2c0,0.3-0.3,0.6-0.6,0.6c-0.3,0-0.6-0.3-0.6-0.6c0-0.3,0.3-0.6,0.6-0.6
  ...
  Close: (
    <Svg.G>
      <Svg.Path d="M945.7,989.4L10,53.8L54.3,9.4L990,945.1L945.7,989.4z"/>
      <Svg.Path d="M10,946.2L945.7,10.6L990,54.9L54.3,990.6L10,946.2L10,946.2z"/>
    </Svg.G>
  ),
  IconArrowRight: (
    <Svg.Path id="icon-arrow-right" d="M22.5,12l-7.6-7.6l-0.3-0.3c-0.4-0.4-0.4-1,0-1.4c0.4-0.4,1-0.4,1.4,0
  ...
  EyeShow: (
    <Svg.G>
      ...
      <Svg.Circle cx="17.19" cy="7.85" r="4.02"/>
    </Svg.G>
  ),
  ...
  CaretDown: <Svg.Path d="M.09,0C0,0,0,.05,0,.13L6.89,8.72a.13.13,0,0,0,.21,0L14,.13C14,.05,14,0,13.91,0Z"/>,
  IconChevronLeft: (
    <Svg.G><Svg.Path
      d="M9.76.41.4,9.4a1.29,1.29,0,0,0,0,1.86l9.36,9a1.48,1.48,0,0,0,2.05-2.14L4,10.58a.35.35,0,0,1,0-.5l7.84-7.53a1.48,1.48,0,0,0-1-2.55A1.51,1.51,0,0,0,9.76.41Z"/></Svg.G>
  ),
  WarningCircleViewBox: "0 0 29 29",
  WarningCircle: (
    <Svg.G>
      <Svg.Path className="cls-1"
  ...
  CheckCircle: <Svg.Path className="cls-1" d="M14.5,0A14.5,14.5,0,1,0,29,14.5,14.5,14.5,0,0,0,14.5,0Zm8.23,9.92L13,20.74a.42.42,0,0,1-.28.14h0l-.1,0a.4.4,0,0,1-.2-.09L6.53,15.51a.47.47,0,0,1-.14-.29.44.44,0,0,1,.11-.29l1-1.12a.41.41,0,0,1,.58,0l4.41,4L21,8.35a.41.41,0,0,1,.58,0l1.12,1a.37.37,0,0,1,.13.28A.41.41,0,0,1,22.73,9.92Z"/>,
  InfoCircleViewBox: "0 0 29 29",
  InfoCircle: <Svg.Path className="cls-1" d="M14.5,0A14.5,14.5,0,1,0,29,14.5,14.5,14.5,0,0,0,14.5,0Zm-.07,6.75a1,1,0,0,1,1,.92.89.89,0,0,1-.88.91h-.07a.92.92,0,1,1,0-1.83Zm1.4,16.45H13.17a.87.87,0,1,1,0-1.73h.46V12.53h-.46a.87.87,0,1,1,0-1.73H14.5a.87.87,0,0,1,.87.87v9.8h.46a.87.87,0,1,1,0,1.73Z"/>,
  CloseCircleViewBox: "0 0 29 29",
  CloseCircle: <Svg.Path className="cls-1" d="M14.5,0A14.5,14.5,0,1,0,29,14.5,14.5,14.5,0,0,0,14.5,0Zm5.34,18.64a.85.85,0,0,1,0,1.2.82.82,0,0,1-.6.25.83.83,0,0,1-.6-.25l-4-4-4,4a.83.83,0,0,1-.6.25.82.82,0,0,1-.6-.25.85.85,0,0,1,0-1.2l4-4-4-4a.85.85,0,0,1,1.2-1.2l4,4,4-4a.85.85,0,1,1,1.2,1.2l-4,4Z"/>,
  Search: <Svg.Path d="M15.19,14.85a7.94,7.94,0,1,0-.38.38A1.46,1.46,0,0,1,15,15,1.84,1.84,0,0,1,15.19,14.85Zm1.63.13,0,0L23,21.17a1.33,1.33,0,1,1-1.88,1.89L15,16.91l0-.05A9.39,9.39,0,1,1,16.82,15Z"/>,
  GreenCheckViewBox: "0 0 26 26",
  GreenCheck: <Svg.G>
      <Svg.Path fill="#4fb895" d="M13,0h0A13,13,0,1,1,0,13,13,13,0,0,1,13,0Z"/>
      <Svg.Path fill="#fff" d="M20,8.89l-.89-.81a.32.32,0,0,0-.46,0l-6.77,7.5L8.35,12.43a.33.33,0,0,0-.46,0l-.81.9a.36.36,0,0,0-.08.23.3.3,0,0,0,.11.23L11.75,18a.35.35,0,0,0,.16.08H12a.38.38,0,0,0,.23-.11L20,9.35a.29.29,0,0,0,.08-.23A.3.3,0,0,0,20,8.89" />
  </Svg.G>,
};