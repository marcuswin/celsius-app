...
const  { G, Path, Circle, Polyline } = Svg;
...
export default {
  ...
  IconArrowRightViewBox: '0 0 26 26',
  IconArrowRight: (
  ...
  IconChevronLeft: (
    <G>
      <Path d="M9.76.41.4,9.4a1.29,1.29,0,0,0,0,1.86l9.36,9a1.48,1.48,0,0,0,2.05-2.14L4,10.58a.35.35,0,0,1,0-.5l7.84-7.53a1.48,1.48,0,0,0-1-2.55A1.51,1.51,0,0,0,9.76.41Z"/>
    </G>
  ),
  IconChevronRightViewBox: "0 0 6.42 10",
  IconChevronRight: (
    <G>
      <Path d="M1.31,9.8,6.22,5.45a.6.6,0,0,0,0-.9L1.31.2A.81.81,0,0,0,.24.2a.68.68,0,0,0,0,1l4.1,3.64a.15.15,0,0,1,0,.24L.24,8.76a.68.68,0,0,0,0,1,.82.82,0,0,0,1.07,0Z"/>
    </G>
  ),
  ...
  SwitchViewBox: "0 0 18.74 28.05",
  Switch: (
    <G>
      <G className="cls-2">
        <Path className="cls-1"
              d="M18.52,23,14,27.6l-.22.21a.77.77,0,0,1-1.12,0l-.22-.21L7.94,23a.77.77,0,0,1,0-1.09.76.76,0,0,1,1.09,0l3.4,3.48v-14a.78.78,0,0,1,1.56,0v14l3.4-3.48a.76.76,0,0,1,1.09,0,.77.77,0,0,1,0,1.09"/>
        <Path className="cls-1"
              d="M.22,5.07,4.73.45,5,.23A.65.65,0,0,1,5.21.06.77.77,0,0,1,5.51,0,.68.68,0,0,1,5.8.06a.69.69,0,0,1,.27.17l.22.22L10.8,5.07a.77.77,0,0,1,0,1.09.76.76,0,0,1-1.09,0L6.29,2.68v14a.78.78,0,0,1-1.56,0v-14L1.32,6.16a.75.75,0,0,1-1.08,0,.76.76,0,0,1,0-1.09"/>
      </G>
      <Polyline className="cls-3" points="39 -278.56 -336 -278.56 -336 533.44 39 533.44" fill="none"/>
    </G>
  )
};
